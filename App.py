...
# Ruta para el Ejercicio 1 - Formulario de pinturas
...
def procesar_ejercicio1():
    ...
    # Cálculo del descuento según edad
    if 18 <= edad <= 30:
        descuento = 0.15
    elif edad > 30:
        descuento = 0.25
...
# Ruta para el Ejercicio 2 - Formulario de login
@app.route('/ejercicio2')
def ejercicio2():
    return render_template('ejercicio2.html')

# Ruta para procesar el Ejercicio 2
